...
nmrPipe -in /Users/jmwe/Documents/nmrdata/MarcelUtz/b2m/db2m_1mM_13chsqc2.fid/test.fid     \
| nmrPipe -fn POLY -time                                       \
| nmrPipe  -fn SP -off 0.5 -end 1.00 -pow 1 -c 1.0    \
| nmrPipe  -fn ZF -auto                               \
| nmrPipe  -fn FT -auto                               \
| nmrPipe  -fn PS -p0 -151.00 -p1 87.00 -di -verb         \
| nmrPipe  -fn TP                                     \
| nmrPipe -fn LP -fb                                           \
| nmrPipe  -fn SP -off 0.5 -end 1.00 -pow 1 -c 1.0    \
| nmrPipe  -fn ZF -auto                               \
...
| nmrPipe -fn TP                                               \
| nmrPipe -fn POLY -auto                                       \
   -ov -out /Users/jmwe/Documents/nmrdata/MarcelUtz/b2m/db2m_1mM_13chsqc2.fid/test.ft2
